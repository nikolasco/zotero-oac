		...
		function newChannel(uri) {
			...
			try {
				...
				if (!redirected && anno && anno.getHTMLString) {
					// At this point, we have an annotater and will get HTML
					// to load as a content document. Since this is being
					// generated by chrome, it should be trustworthy
					// (assuming it doesn't let content execute somehow)
